/**
 * Type definitions for Web Design Guidelines rules
 */
...
export interface CodeExample {
  ...
  code: string
  language?: string // Default: 'html' or 'css' or 'typescript'
...
export interface Rule {
  ...
  impact: ImpactLevel
  impactDescription?: string // e.g., "accessibility improvement"
  explanation: string
