...
function generateMarkdown(
  ...
  md += `> generating, or reviewing web UI code. Humans may also find it useful,  \n`
  md += `> but guidance here is optimized for automation and consistency by AI-assisted workflows.\n\n`
  md += `---\n\n`
  md += `## Abstract\n\n`
  ...
  try {
    ...
    try {
      ...
      metadata = {
        ...
        abstract:
          'Web design guidelines for building accessible, performant, and user-friendly interfaces.',
      }
    }
