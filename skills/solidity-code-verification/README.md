...
Agents use this skill to submit Solidity smart contract code for verification and receive expert analysis. The workflow handles wallet verification, job submission, payment, and result retrieval.
...
3. Submit Solidity code via `acp job create`
...
- **Offering Name**: `solidity-code-verification`
- **Requirements Field**: `{"solidity_code": "SOLIDITY_CODE"}`
