...
- **General documentation**: https://github.com/github/copilot-sdk/tree/main/docs
- **Cookbook**: https://github.com/github/awesome-copilot/tree/main/cookbook/copilot-sdk
- **Other resources**: https://github.com/github/awesome-copilot/blob/main/collections/copilot-sdk.md
...
async def main():
    ...
    while True:
        ...
        await session.sendAndWait({"prompt": user_input})
        print("\n")
...
| Option | Description |
|--------|-------------|
| `model` | LLM to use ("gpt-4.1", "gpt-4o", "claude-sonnet-4.5", etc.) |
