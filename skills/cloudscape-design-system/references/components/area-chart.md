---
scraped_at: '2026-04-20T08:46:40+00:00'
section: components
source_url: https://cloudscape.design/components/area-chart/index.html.md
title: Area chart
---
...
- Don't use area charts to visualize only one data series, use a [line chart](/components/line-chart/index.html.md)   instead.
- Don't use area charts when showing negative data. Use a [line](/components/line-chart/index.html.md)   or [bar](/components/bar-chart/index.html.md)   chart instead.
...
- #### Axis labels
  ...
  - **X axis labels **     -** **     Shown below the X axis and often used for time intervals.    
    ...
    - For example: *27 Jan, 28 Jan, 29 Jan, 30 Jan, 31 Jan*
...
- #### Details popover
  ...
  Provides additional information on specific data points by using a [popover](/components/popover/index.html.md)   . There are two main ways to interact with the details popover:  
  ...
  The details popover supports all [popover sizes](/components/popover/index.html.md)   . Use the appropriate popover size based on the amount of information you want to display, such as the length of associated labels. To enable additional actions on the selected data point on a chart, use the footer to add a [button](/components/button/index.html.md)   or [button dropdown](/components/button-dropdown/index.html.md)  .
- #### Thresholds - optional
